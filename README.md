...
Built a quantum computing simulation platform on an Artix-7 Cmod-A7 dev board to explore both FPGA development and quantum mechanics. Implemented quantum gate operations in SystemVerilog with real-time state visualization.
Check out the [repo](https://github.com/RaghavS06/FPGA-Quantum-Computer) for SystemVerilog code and output pictures.
